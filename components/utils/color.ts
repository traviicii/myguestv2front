...
export const FALLBACK_COLORS = {
  ...
  glassHighlightStrong: 'rgba(255, 255, 255, 0.35)',
  glassHighlightSoft: 'rgba(255, 255, 255, 0.05)',
  glassHighlightMid: 'rgba(255, 255, 255, 0.2)',
  cyberPrimaryBg: '#202B20',
  cyberSurfaceCard: '#121212',
  cyberAccent: '#D7FF5C',
  danger: '#EF4444',
  modalOverlaySoft: 'rgba(10, 15, 24, 0.34)',
  sheetOverlaySoft: 'rgba(15, 23, 42, 0.34)',
